...
import { CRCApiResponse } from 'src/app/generatedapis/models/CRCApiResponse';
...
@Component({
  selector: 'app-crc-form',
  templateUrl: './crc-form.component.html',
  styleUrls: ['./crc-form.component.scss']
})
export class CrcFormComponent implements OnInit {
  ...
  GetDataById(Id: string) {
    this._loader.show();
    CrCsService.getApiCrCsGetByIdAsync(this.Id).then((res: CRCApiResponse) => {
