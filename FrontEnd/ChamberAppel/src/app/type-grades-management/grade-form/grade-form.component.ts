import { TypeGradesService } from './../../generatedapis/services/TypeGradesService';
...
import { TypeGradeApiResponse } from 'src/app/generatedapis/models/TypeGradeApiResponse';
...
export class GradeFormComponent implements OnInit {
  ...
  GetDataById(Id: string) {
    this._loader.show();
    TypeGradesService.getApiTypeGradesGetByIdAsync(this.Id).then((res: TypeGradeApiResponse) => {
