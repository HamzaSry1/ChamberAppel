...
{
    class RequeteAppelImportService : IRequeteAppelImportService
    {

        private readonly IRequeteAppelImportRepository _repository;

        public RequeteAppelImportService(IRequeteAppelImportRepository repository)
        {
        ...
        public async Task<bool> Upload(IFormFile file, string updatedBy)
        {
            try
            {
                ...
                var list = ImportHelpers.DataTableToList<RequeteAppelTemp>(dataTable);
