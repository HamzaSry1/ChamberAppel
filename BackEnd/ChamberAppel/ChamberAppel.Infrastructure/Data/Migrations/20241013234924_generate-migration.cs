        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CRC = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Centre_Comptable = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Exercice_fiscal = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Date_Enregistrement_Requete_Cour_Regionale_Des_Comptes = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Conseiller_Rapporteur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Ordonnance_Designation_Conseiller_Rapporteur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Conseiller_Rapporteur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    Reponse_au_memoire_d_appel_President_de_la_Commune = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Preparation_Rapport = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Designation_du_Conseiller_Reviseur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Designation_du_Conseiller_Reviseur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Designation_du_Conseiller_Reviseur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Designation_du_Conseiller_Reviseur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_de_preparation_de_l_avis_de_l_examinateur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Transmission_Dossier_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Retour_Dossier_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Conclusions_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Numero_Conclusions_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_de_la_session = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Dispositif_Decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Numero_Decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_d_envoi_de_la_decision_pour_notifier_les_parties = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_de_reception_par_le_comptable_d_une_copie_de_la_decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    UpdateTime = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    RowNumber = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    RowError = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequetesAppelTemp", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Appelant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Numero_Jugement_Faisant_Objet_De_Appel = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Emis_En_Date_Du = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IdCRC = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    Centre_Comptable = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Enregistrement_Requete_Cour_Regionale_Des_Comptes = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Requisition_Ministere_Public = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Numero_Requisition_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Ordonnance_Designation_Conseiller_Rapporteur = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Numero_Ordonnance_Designation_Conseiller_Rapporteur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Conseiller_Rapporteur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Ordonnance_Designation_Conseiller_Rapporteur_Remplacant = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Numero_Ordonnance_Designation_Conseiller_Rapporteur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Conseiller_Rapporteur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Envoi_Requete_Parties = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Parties_Agent_du_Roi_au_CRC = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Parties_Entrepot_Regional = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Parties_Travailleur_du_territoire = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Parties_President_de_la_Commune = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    Reponse_au_memoire_d_appel_Travailleur_du_territoire = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Reponse_au_memoire_d_appel_President_de_la_Commune = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Demande_Documents_Supplementaires = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Convocation_Interesse_Audience = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Enquete_Sur_Le_Terrain = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Preparation_Rapport = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Transmission_Dossier_Ministere_Public = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Conclusions_Ministere_Public = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Numero_Conclusions_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Reception_Convocation_Interesse_Consultation = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Reception_Convocation_Avocat_Consultation = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Consultation_Interesse = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Consultation_Avocat = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Retour_Dossier_Greffe_Central = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Convocation_Interesse_Audience_Jugement = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Convocation_Avocat_Audience_Jugement = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Audience_Jugement = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Convocation_Avocat_Prononce_Jugement = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Convocation_Interesse_Prononce_Jugement = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Audience_Prononce_Jugement = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Dispositif_Decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Numero_Decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Envoi_Decision_Notification_Parties = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Reception_Comptable_Copie_Decision = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdCRC = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    Centre_Comptable = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Exercice_fiscal = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    Date_Enregistrement_Requete_Cour_Regionale_Des_Comptes = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Conseiller_Rapporteur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Ordonnance_Designation_Conseiller_Rapporteur = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Conseiller_Rapporteur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    Date_Preparation_Rapport = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Designation_du_Conseiller_Reviseur = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Designation_du_Conseiller_Reviseur = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Designation_du_Conseiller_Reviseur_Remplacant = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_Designation_du_Conseiller_Reviseur_Remplacant = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_de_preparation_de_l_avis_de_l_examinateur = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Transmission_Dossier_Ministere_Public = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Retour_Dossier_Ministere_Public = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_Conclusions_Ministere_Public = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Numero_Conclusions_Ministere_Public = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_de_la_session = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Dispositif_Decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Numero_Decision = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Date_d_envoi_de_la_decision_pour_notifier_les_parties = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Date_de_reception_par_le_comptable_d_une_copie_de_la_decision = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "NVARCHAR2(80)", maxLength: 80, nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IsActive = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequetesAppel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequetesAppel_CRCs_IdCRC",
                        column: x => x.IdCRC,
                        principalTable: "CRCs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
