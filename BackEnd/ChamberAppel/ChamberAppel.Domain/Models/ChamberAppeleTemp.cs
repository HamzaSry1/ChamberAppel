...
{
    public class ChamberAppeleTemp
    {
        ...
        //السنة المالية
        public string Exercice_fiscal { get; set; }
        ...
        public string? Date_Designation_du_Conseiller_Reviseur_Remplacant { get; set; }

        //تاريخ اعداد راي المستشار المراجع
        public string? Date_de_preparation_de_l_avis_de_l_examinateur { get; set; }
        ...
        public string? Date_Retour_Dossier_Ministere_Public { get; set; }
        ...
        //تاريخ الجلسة
        public string? Date_de_la_session { get; set; }
        ...
        public string? Date_d_envoi_de_la_decision_pour_notifier_les_parties { get; set; }

        //تاريخ  توصل المحاسب بنسخة من القرار
        public string? Date_de_reception_par_le_comptable_d_une_copie_de_la_decision { get; set; }
